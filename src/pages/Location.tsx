...
export const Location = ({ setAppear }: { setAppear: () => void }) => {
  return (
    <Section>
      ...
      <AppearObserver>
        <div className="mt-6 text-center text-15 text-neutral-700 opacity-75">
      ...
      <AppearObserver>
        <div className="flex justify-between w-64 gap-2 items-center mx-auto text-xs opacity-80 mt-7">
          <a href="https://naver.me/xwmiFiaC">
            <div className="flex gap-2 justify-center items-center cursor-pointer">
              <div className="map-icon">
                <div className="naver w-full h-full"></div>
              </div>
              <div className="text-neutral-700 opacity-90 text-xs">
                네이버 지도
              </div>
            </div>
          </a>
          ...
          <a href="https://tmap.life/9eac1d7d">
            <div className="flex gap-2 justify-center items-center cursor-pointer">
              ...
              <div className="text-neutral-700 opacity-90 text-xs">티맵</div>
            </div>
          </a>
        </div>
      </AppearObserver>
